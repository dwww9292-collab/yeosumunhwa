...
// 소식(공지/보도) — 실제 양주 문화행사 헤드라인 (이 섹션은 이미지 없이 제목만 노출)
export const realNewsItems = [
  { id: 9001, category: "보도자료", title: "국가무형유산 양주별산대놀이 상설공연 개최 안내", date: "2026-06-10", isNew: true },
  { id: 9002, category: "보도자료", title: "양주시립합창단 정기연주회 개최", date: "2026-06-05", isNew: true },
