...
export const newsItems = [
  {
    id: 1,
    category: "공지사항",
    title: "[여수문화관광재단 공고 제2026-37호] 2026 공연창작 지원사업 최종 선정 결과 공고",
    date: "2026-06-02",
    isNew: true,
  },
  {
    id: 2,
    category: "공지사항",
    title: "[여수문화관광재단 공고 제2026-36호] 2026년 경기 생활문화 공간 활성화 지원사업 <한뼘 더 커뮤니티> 서류심사 결과 공고",
    date: "2026-05-29",
    isNew: false,
  },
  {
    id: 3,
    category: "공지사항",
    title: "여수문화관광재단 임직원 사칭 허위 구매 사기 피해 예방 안내",
    date: "2026-05-08",
    isNew: false,
  },
];
