...
const greetings = [
  {
    ...
    label: "이사장",
    name: "여수문",
    position: "여수문화관광재단 이사장",
    title: "품격 있는 문화도시, 여수를 향한 힘찬 여정에 함께해 주십시오",
    subtitle: "여수문화관광재단을 찾아주신 시민 여러분, 반갑습니다.",
...
이러한 변화와 도전 속에서, 지역민과 문화인들의 오랜 염원을 담아 여수문화관광재단이 출범하게 되었습니다. 재단은 지역의 역사와 문화, 예술 자원을 아우르는 통합 문화예술 플랫폼으로서, 누구나 차별 없이 마음껏 문화예술을 즐길 수 있는 환경을 조성하겠습니다.
...
여러분의 따뜻한 관심과 성원을 부탁드립니다.`,
  ...
  },
  {
    ...
    label: "대표이사",
    name: "화재단",
    position: "여수문화관광재단 대표이사",
    title: "시민의 삶에 문화의 가치를 더하는 재단이 되겠습니다",
    subtitle: "안녕하십니까, 여수문화관광재단 대표이사 화재단입니다.",
    ...
    content: `여수문화관광재단은 '시민과 함께하는 문화예술의 가치 실현'이라는 사명 아래, 공연·전시·교육·축제 등 다양한 문화예술 프로그램을 통해 여수 시민들의 삶의 질을 높이는 데 최선을 다하고 있습니다.
      ...
      <div className="px-4 md:px-8 py-10 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-gray-500 max-w-2xl mx-auto leading-relaxed">
            여수문화관광재단을 이끌어가는 이사장과 대표이사의 인사말을 통해
