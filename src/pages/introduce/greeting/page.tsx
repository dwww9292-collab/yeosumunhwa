...
const greetings = [
  {
    ...
    name: "양주문",
    position: "양주문화재단 이사장",
    title: "품격 있는 문화도시, 양주를 향한 힘찬 여정에 함께해 주십시오",
    subtitle: "양주문화재단을 찾아주신 시민 여러분, 반갑습니다.",
    ...
    content: `양주시는 인구 50만 명을 달성하며, 당당히 대도시로 도약했습니다. 풍부한 잠재력과 경쟁력을 지닌 양주는, 100만 문화도시로의 비상을 준비하고 있습니다.

이러한 변화와 도전 속에서, 지역민과 문화인들의 오랜 염원을 담아 양주문화재단이 출범하게 되었습니다. 재단은 지역의 역사와 문화, 예술 자원을 아우르는 통합 문화예술 플랫폼으로서, 누구나 차별 없이 마음껏 문화예술을 즐길 수 있는 환경을 조성하겠습니다.

시민 여러분의 다양한 목소리에 귀 기울이며, 모두가 참여하고 함께 만드는 문화예술을 실현해 나가겠습니다. 시민과 함께 성장하며, 예술과 문화가 일상 속에서 살아 숨 쉬는 '품격 있는 문화도시, 양주'를 만들어 가겠습니다.

여러분의 따뜻한 관심과 성원을 부탁드립니다.`,
    signature: "양주문화재단 이사장 양주문",
    visionItems: [
  ...
  },
  {
    ...
    label: "대표이사",
    name: "화재단",
    position: "양주문화재단 대표이사",
    title: "시민의 삶에 문화의 가치를 더하는 재단이 되겠습니다",
    subtitle: "안녕하십니까, 양주문화재단 대표이사 화재단입니다.",
    ...
    content: `양주문화재단은 '시민과 함께하는 문화예술의 가치 실현'이라는 사명 아래, 공연·전시·교육·축제 등 다양한 문화예술 프로그램을 통해 양주 시민들의 삶의 질을 높이는 데 최선을 다하고 있습니다.

우리 재단은 단순한 문화시설 운영을 넘어, 지역 예술인들이 마음껏 창작 활동을 펼칠 수 있는 플랫폼이자, 시민 누구나 일상에서 문화를 향유할 수 있는 열린 공간이 되고자 합니다.

앞으로도 변함없는 열정과 사명감으로 양주의 문화예술 발전을 위해 정진하겠습니다. 여러분의 많은 관심과 참여를 부탁드립니다.`,
    signature: "양주문화재단 대표이사 화재단",
    visionItems: [
      ...
      <div className="px-4 md:px-8 py-10 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-gray-500 max-w-2xl mx-auto leading-relaxed">
            양주문화재단을 이끌어가는 이사장과 대표이사의 인사말을 통해
