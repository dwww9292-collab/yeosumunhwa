        ...
        <div className="space-y-6 max-w-3xl mx-auto">
          <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">(우)11461, 경기도 양주시 광적면 부흥로618번길 303</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-xl border border-gray-200">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 leading-relaxed">수도권 전철 1호선 양주역 하차 → 버스 이용 (30분 소요)</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-xl border border-gray-200">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-2">양주도시공사·문화예술회관 정류장 하차</p>
