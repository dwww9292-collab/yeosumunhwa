...
const teamData = [
  {
    ...
    color: "#1a4fa0",
    members: [
      { role: "팀장", phone: "[확인필요]", duties: ["경영지원업무 총괄", "유관기관 협력", "감사(윤리 및 인권경영)", "경영전략(ESG)", "기관 홍보"] },
      { role: "팀원", phone: "[확인필요]", duties: ["조직·정원·인사·노무", "예산", "경영평가", "이사회·제규정", "시·시의회 대응"] },
      { role: "팀원", phone: "[확인필요]", duties: ["건축 시설 유지관리", "시민회관 청사관리", "안전·보건관리", "계약(물품·공사)", "직원 교육"] },
      { role: "팀원", phone: "[확인필요]", duties: ["재무·세무관리, 결산", "급여", "복리후생", "경영공시 및 통합공시", "홈페이지 관리"] },
      { role: "팀원", phone: "[확인필요]", duties: ["소방 안전관리", "기계설비 유지관리", "소방 시스템 관리", "전산시스템 관리", "정보보안, 차량관리"] },
      { role: "팀원", phone: "[확인필요]", duties: ["지출, 회계관리", "계약(물품·공사·용역)", "복무관리", "총무 및 기록물관리"] },
      { role: "팀원", phone: "[확인필요]", duties: ["전기안전관리", "전기 및 승강기 유지관리", "공공요금 납부", "물품구매 및 자산관리", "개인정보보호(CCTV), 통신"] },
    ],
  },
  {
    name: "문화사업팀",
    ...
    color: "#2d8c4a",
    members: [
      { role: "팀장", phone: "[확인필요]", duties: ["문화사업 총괄 기획", "지역문화 활성화 사업", "문화예술교육 사업", "공연창작 지원사업"] },
      { role: "팀원", phone: "[확인필요]", duties: ["가가호호 프로그램 운영", "율곡문화학당 운영", "찾아가는 문화하루 운영", "혜음원지 방문자센터 운영"] },
      { role: "팀원", phone: "[확인필요]", duties: ["지원사업 공모 및 심사", "예술인 지원", "문화복지 사업", "생활문화 지원사업"] },
    ],
  },
  {
    name: "공연전시팀",
    ...
    color: "#f5a623",
    members: [
      { role: "팀장", phone: "[확인필요]", duties: ["공연사업 총괄", "기획공연 운영", "문화살롱 운영", "실내악 시리즈 운영"] },
      { role: "팀원", phone: "[확인필요]", duties: ["대관 심사 및 관리", "공연장 운영", "전시 기획", "축제 운영"] },
      { role: "팀원", phone: "[확인필요]", duties: ["공연 기술 지원", "음향·조명 운영", "무대 제작", "장비 관리"] },
    ],
  },
  {
    name: "무대운영팀",
    ...
    color: "#8b5cf6",
    members: [
      { role: "팀장", phone: "[확인필요]", duties: ["무대 총괄 운영", "시설 유지보수", "안전 관리", "장비 점검"] },
      { role: "팀원", phone: "[확인필요]", duties: ["무대 설치 및 철수", "음향 장비 운영", "조명 시스템 운영"] },
      { role: "팀원", phone: "[확인필요]", duties: ["영상 장비 운영", "인터넷 방송 지원", "공연장 청소 및 관리"] },
    ],
  },
];
          ...
          <div className="mt-6 p-4 bg-[#f5a623]/5 border border-[#f5a623]/20 rounded-xl flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                ...
                업무 시간 외 문의는 이메일([확인필요])을 이용해 주시기 바랍니다.
              </p>
            </div>
          </div>
        </div>
