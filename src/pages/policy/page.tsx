...
const CONTENT: Record<Slug, { title: string; intro: string; sections: Section[] }> = {
  privacy: {
    title: "개인정보처리방침",
    intro:
      "양주문화재단(이하 '재단')은 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보처리방침을 수립·공개합니다.",
    sections: [
      {
  ...
  video: {
    ...
    intro:
      "양주문화재단은 「개인정보 보호법」 제25조 제7항에 따라 영상정보처리기기(CCTV)의 운영·관리에 관한 방침을 다음과 같이 수립·공개합니다.",
    sections: [
  ...
  terms: {
    title: "서비스 이용약관",
    intro: "본 약관은 양주문화재단이 제공하는 웹사이트 및 관련 서비스의 이용 조건과 절차, 이용자와 재단의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.",
    sections: [
