...
const CONTENT: Record<Slug, Policy> = {
  privacy: {
    title: "개인정보처리방침",
    intro:
      "여수문화관광재단(이하 '재단')은 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보처리방침을 수립·공개합니다.",
    sections: [
      {
  ...
  video: {
    ...
    intro:
      "여수문화관광재단은 「개인정보 보호법」 제25조 제7항에 따라 영상정보처리기기(CCTV)의 운영·관리에 관한 방침을 다음과 같이 수립·공개합니다.",
    sections: [
  ...
  terms: {
    title: "서비스 이용약관",
    intro: "본 약관은 여수문화관광재단이 제공하는 웹사이트 및 관련 서비스의 이용 조건과 절차, 이용자와 재단의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.",
    sections: [
  ...
  copyright: {
    title: "저작권 보호정책",
    intro:
      "여수문화관광재단이 창작한 저작물은 공공누리 제1유형(출처표시)에 따라 별도의 이용허락 절차 없이 자유롭게 이용하실 수 있습니다. 다만 제3자에게 저작권이 있는 자료는 적용 대상에서 제외되므로, 이용 전 아래 내용을 확인해 주시기 바랍니다.",
    sections: [
      {
        heading: "공공누리 제1유형 (출처표시)",
        body:
          "재단이 저작재산권 전부를 보유한 공공저작물은 공공누리 제1유형으로 개방합니다.\n- 출처를 표시하면 상업적 이용이 가능합니다.\n- 변형 및 2차적 저작물 작성이 가능합니다.\n\n출처 표시 예시: \"본 저작물은 여수문화관광재단에서 [작성연도] 작성하여 공공누리 제1유형으로 개방한 저작물입니다.\"",
      },
      {
        heading: "적용 제외 대상",
        body:
  ...
  return (
    <div className="mb-8 flex flex-col sm:flex-row items-start gap-4 rounded-lg border border-[#1a4fa0]/30 bg-[#1a4fa0]/5 p-5">
      ...
      <div className="text-sm text-gray-700 leading-relaxed">
        ...
        <p>
          여수문화관광재단이 창작한 공공저작물은 출처를 표시하면 상업적 이용과 변형이
          모두 가능합니다. 자세한 내용은{" "}
          <a
